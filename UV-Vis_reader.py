...
directory = r'C:\Users\Peter\Documents\Postdoctorate\Work\CAKE\Case studies\AA\21042203_Run' # enter file directory
show_first_spec = "No"  # enter "Y" or "Yes" if you want to see first image, to aid region limit selection
region_limits_pri = (260, 270)  # enter primary (x1, x2, y1, y2) area for pixel abstraction
...
exportpath = r'C:\Users\Peter\Documents\Postdoctorate\Work\CAKE\Case studies\AA\PJHW_22042203_260-270.xlsx'  # enter Excel path for export
