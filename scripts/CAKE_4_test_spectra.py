...
from scripts import cake_main_4 as cake
import numpy as np
import pandas as pd
import timeit
...
if __name__ == "__main__":
    ...
    if "sim" in sim_or_fit and 'n' in excel_source:
        ...
        plot_output = cake.plot_time_vs_conc(x_data_df, y_fit_conc_df=y_fit_conc_df, show_asp=show_asp,
        ...
        for i in range(0, len(df)):
            ...
            plot_output = cake.plot_time_vs_conc(x_data_df, y_fit_conc_df=y_fit_conc_df, show_asp=show_asp,
                                                 method="sep", f_format='png', save_disk=True, save_to=pic_save)
            plot_output = cake.plot_conc_vs_rate(x_data_df, y_fit_conc_df, y_fit_rate_df, ord_lim,
        ...
        for i in range(0, len(df)):
            ...
            plot_output = cake.plot_time_vs_conc(x_data_df, y_exp_conc_df=y_exp_conc_df, y_fit_conc_df=y_fit_conc_df,
            ...
            plot_output = cake.plot_conc_vs_rate(x_data_df, y_fit_conc_df, y_fit_rate_df, total_ord,
